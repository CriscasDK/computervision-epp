...
if __name__ == "__main__":
    ...
    scheduler.add_job(run_upload_job,
                    'cron',
                    hour=hours_str,
                    minute=minute_int,
                    misfire_grace_time=None, #30*60,
                    coalesce=True,          # Si se pierden ejecuciones, solo corre la última pendiente
                    max_instances=1         # Nunca más de una instancia de upload corriendo
                    )
